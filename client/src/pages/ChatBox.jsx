    ...
    <div className="flex flex-col h-screen">
                ...
                >
                  {message.message_type === "image" && (
                    <img
                      ...
                      className="w-full max-x-sm rounded-lg mb-1"
                      alt=""
                    />
                  )}
                  <p>{message.text}</p>
      ...
      <div className="px-4">
        <div className="flex items-center gap-3 pl-5 p-1.5 bg-white w-full max-w-xl mx-auto border border-gray-200 shadow rounded-full mb-5">
          ...
          <button onClick={sendMessage} className="bg-gradient-to-b from-indigo-50 to-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95 cursor-pointer text-white p-2 rounded-full">
