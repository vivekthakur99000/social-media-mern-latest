    ...
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="inline-flex flex-wrap items-center border border-gray-200 rounded-md p-1 bg-white shadow-sm">
          {dataArray.map((tab) => (
            <button
              ...
              key={tab.label}
              className={`flex items-center px-3 py-1 rounded-md transition-colors text-sm cursor-pointer ${
                currenntTab === tab.label
        ...
        <div className="flex flex-wrap gap-6 mt-6">
          {dataArray
            .find((item) => item.label === currenntTab)
            .value.map((user) => (
              <div
                key={user._id}
              ...
              >
                <img
                  ...
                  className="eounded-full w-12 h-12 shadow-md mx-auto"
                  alt=""
                />
                  ...
                  <div className="flex max-sm:flex-col gap-2 mt-4">
                    {
                      <button
                        ...
                        className="w-full p-2 text-sm rounded bg-gradient-to-r from-indigo-500 to-purple-50 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition text-white cursor-pointer "
                      >
                        view profile
                      </button>
                    }
